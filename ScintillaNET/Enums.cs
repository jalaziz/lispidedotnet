...
namespace ScintillaNet
{
    ...
    /// <summary>
    /// Indent view for indent guides
    /// </summary>
    public enum IndentGuideView
    {
        /// <summary>
        ...
        Real = 1,
        /// <summary>
        /// Indentation guides are shown beyond the actual indentation up to the level 
        /// of the next non-empty line
        /// </summary>
        LookForward = 2,
        /// <summary>
        /// Indentation guides are shown beyond the actual indentation up to the level 
        /// of the next non-empty line or previous non-empty line whichever is the greater
        /// </summary>
        LookBoth = 3
    }
}
