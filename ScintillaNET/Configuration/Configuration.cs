...
namespace ScintillaNet.Configuration
{
	public class Configuration
	{
				...
				while (reader.MoveToNextAttribute())
				{
					...
					switch (attrName)
					{
						...
						case "indentwidth":
							...
							break;
						case "guides":
					        _indentation_Guides = (IndentGuideView)Enum.Parse(typeof(IndentGuideView), reader.Value, true);
							break;
						case "tabindents":
		...
		public void Load(XmlDocument configDocument)
		{
			...
			if (indentationNode != null)
			{
                ...
                try
                {
                    _indentation_Guides =
                        (IndentGuideView)
                        Enum.Parse(typeof(IndentGuideView), indentationNode.GetAttribute("Guides"), true);
                } catch (ArgumentException) { }
		...
		private IndentGuideView? _indentation_Guides;
        public IndentGuideView? Indentation_Guides
		{
			get
			{
				return _indentation_Guides;
			}
			set
			{
				_indentation_Guides = value;
			}
		}
		#endregion
