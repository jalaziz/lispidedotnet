...
namespace ScintillaNet
{
	...
	public class Indentation : ScintillaHelperBase
	{
		...
		#region Guides
		public IndentGuideView Guides
		{
			get
			{
				return (IndentGuideView)NativeScintilla.GetIndentationGuides();
			}
			set
			{
				NativeScintilla.SetIndentationGuides((int)value);
			}
		}

		private bool ShouldSerializeGuides()
		{
			return Guides != IndentGuideView.None;
		}

		private void ResetGuides()
		{
			Guides = IndentGuideView.None;
		} 
		#endregion
