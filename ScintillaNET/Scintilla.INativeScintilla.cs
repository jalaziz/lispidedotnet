...
namespace ScintillaNet
{
	public partial class Scintilla	
	{
		...
		void INativeScintilla.SetIndentationGuides(int indentView)
		{
            _ns.SendMessageDirect(Constants.SCI_SETINDENTATIONGUIDES, indentView, 0);
		}

		int INativeScintilla.GetIndentationGuides()
		{
			return _ns.SendMessageDirect(Constants.SCI_GETINDENTATIONGUIDES, 0, 0);
		}
